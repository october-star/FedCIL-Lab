...
for SEED in 1 2 3; do
  ...
  python scripts/train.py \
    ...
    --buffer_size 500 \
    --seed "$SEED" \
    --run_name "cifar100_beta01_replay_buf500_seed${SEED}" \
    --no_download
  ...
  python scripts/train.py \
    ...
    --tts_old_weight 1.5 \
    --tts_new_weight 1.0 \
    --run_name "cifar100_beta01_replay_tts_buf500_seed${SEED}" \
    --no_download
  ...
  python scripts/train.py \
    ...
    --gdr_rank 8 \
    --seed "$SEED" \
    --run_name "cifar100_beta01_replay_gdr_backbonegdr_buf500_seed${SEED}" \
    --no_download
  ...
  python scripts/train.py \
    ...
    --tts_old_weight 1.5 \
    --tts_new_weight 1.0 \
    --run_name "cifar100_beta01_replay_gdr_tts_backbonegdr_buf500_seed${SEED}" \
    --no_download
done
