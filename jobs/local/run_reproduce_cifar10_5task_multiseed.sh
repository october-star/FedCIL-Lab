...
for SEED in 1 ; do
  ...
  #   --gdr_rank 8 \
  #   --seed "$SEED" \
  #   --run_name "0521_reproduce_core_cifar10_5task_beta05_replay_gdr_paper_buf300_seed${SEED}" \
  #   --no_download
  ...
  python scripts/train.py \
    ...
    --tts_old_weight 1.1 \
    --tts_new_weight 0.9 \
    --run_name "0522_2_reproduce_core_cifar10_5task_beta05_replay_gdr_tts_paper_buf300_seed${SEED}" \
    --no_download
done
